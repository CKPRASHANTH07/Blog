...
const Read = () => {
  ...
  <div className="flex flex-col justify-between md:py-5">
    <h1 className='sm:text-3xl font-bold text-xl'>Hello</h1>
          <p className="sm:text-2xl leading-relaxed text-[15px] text-black">You made it so simple. My new site is so much faster and easier to work with than my old site. I just choose the page, make the change and click save. No need to think twice before making it.</p>
      ...
      <p className="inline-flex items-center justify-center pb-0.5 mt-5 text-base font-semibold text-blue-600 transition-all duration-200 border-b-2 border-transparent hover:border-blue-600 focus:border-blue-600 w-fit">
              Continue Reading
          </p>
  </div>
</div>
